...
describe 'Postfix::Type::Lookup::Memcache::Host' do
  ...
  it { is_expected.to allow_value(['192.0.2.1', 11211]) }
  it { is_expected.to allow_value(['2001:db8::1', 11211]) }
  it { is_expected.to allow_value(['memcache.example.com', 11211]) }
  ...
  it { is_expected.to allow_value(['inet', '192.0.2.1', 11211]) }
  it { is_expected.to allow_value(['inet', '2001:db8::1', 11211]) }
  it { is_expected.to allow_value(['inet', 'memcache.example.com', 11211]) }
